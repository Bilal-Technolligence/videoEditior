...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String TAG = "Technolligence";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent i = getIntent();
        String option = i.getStringExtra("id");
        ...
        CardView extractImages = (CardView) findViewById(R.id.btnExtractImage);
        CardView fadeEffect = (CardView) findViewById(R.id.btnFadeInOut);
        CardView increaseSpeed = (CardView) findViewById(R.id.btnFastMotion);
        CardView decreaseSpeed = (CardView) findViewById(R.id.btnSlowMotion);
        final CardView reverseVideo = (CardView) findViewById(R.id.btnReverseVideo);
        ...
        final CardView extractAudio = (CardView) findViewById(R.id.btnExtractAudio);
        ...
        if (option.equals("CompressVideo")) {
            cutVideo.setVisibility(View.GONE);
            compressVideo.setVisibility(View.VISIBLE);
            extractAudio.setVisibility(View.GONE);
            extractImages.setVisibility(View.GONE);
            fadeEffect.setVisibility(View.GONE);
            reverseVideo.setVisibility(View.GONE);
        ...
        if (option.equals("ExtractImages")) {
            cutVideo.setVisibility(View.GONE);
            compressVideo.setVisibility(View.GONE);
            extractAudio.setVisibility(View.GONE);
            extractImages.setVisibility(View.VISIBLE);
            fadeEffect.setVisibility(View.GONE);
            reverseVideo.setVisibility(View.GONE);
            increaseSpeed.setVisibility(View.GONE);
            decreaseSpeed.setVisibility(View.GONE);
        ...
        if (option.equals("FadeVideo")) {
            cutVideo.setVisibility(View.GONE);
            compressVideo.setVisibility(View.GONE);
            extractAudio.setVisibility(View.GONE);
            extractImages.setVisibility(View.GONE);
            fadeEffect.setVisibility(View.VISIBLE);
            reverseVideo.setVisibility(View.GONE);
            increaseSpeed.setVisibility(View.GONE);
            decreaseSpeed.setVisibility(View.GONE);
        ...
        if (option.equals("ReverseVideo")) {
            cutVideo.setVisibility(View.GONE);
            compressVideo.setVisibility(View.GONE);
            extractAudio.setVisibility(View.GONE);
            extractImages.setVisibility(View.GONE);
            fadeEffect.setVisibility(View.GONE);
            reverseVideo.setVisibility(View.VISIBLE);
            increaseSpeed.setVisibility(View.GONE);
            decreaseSpeed.setVisibility(View.GONE);
